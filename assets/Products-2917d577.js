...
`;function Wt(e){const[t,r]=f.useState(new Date),o=ke(),{onClose:n,addProdSuccess:a,addProdError:s,product:i}=e,{weight:u,calories:l,_id:c,title:d}=i,[v,E]=f.useState(u),b=v*l/100,[x,{isLoading:m,isError:g,error:A}]=un(),C={product_ID:c,date:pt(new Date(t),"yyyy-MM-dd"),amount:v,calories:b};f.useEffect(()=>{o(Le({isLoading:m,isError:g,error:A}))},[o,A,g,m]);const F=async()=>{const{error:M}=await x(C);M?s(M.data.message):(n(),a(b))};return h.jsxs(Ti,{children:[h.jsxs(Bi,{children:[h.jsx(ji,{type:"text",value:d,readOnly:!0,disabled:!0}),h.jsxs(zi,{children:[h.jsx(Hi,{type:"number",value:v,onChange:M=>E(M.target.value)}),h.jsx(Ni,{children:"grams"})]})]}),h.jsxs(Gi,{children:[h.jsx(Ut,{selectedDate:t,setSelectedDate:r}),h.jsxs(_i,{children:[h.jsx(Ui,{children:"Calories:"}),h.jsx(Wi,{children:b})]})]}),h.jsxs(qi,{children:[h.jsx(Yi,{onClick:F,children:"Add to diary"}),h.jsx(Xi,{onClick:n,children:"Cancel"})]})]})}Wt.propTypes={onClose:P.func.isRequired,addProdSuccess:P.func.isRequired,addProdError:P.func.isRequired,product:P.shape({weight:P.number.isRequired,calories:P.number.isRequired,_id:P.string.isRequired,title:P.string.isRequired}).isRequired};const Ki="/fs-79-react-node-dmytrozhdanov/assets/avocado-b622cf8b.png",Qi=S.div`
  margin: 12px 70px;
  text-align: center;
  width: 157px;
...
`,Zi=S.div`
  background: url(${Ki}) no-repeat center center;
